...
<acme:form readonly="true">
	...
	<acme:form-textbox code="authenticated.task.form.label.workloadHours" path="workloadHours"/>
	<acme:form-textbox code="authenticated.task.form.label.workloadMinutes" path="workloadMinutes"/>
