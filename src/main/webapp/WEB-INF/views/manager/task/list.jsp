...
<acme:list>
	...
	<acme:list-column code="manager.task.list.label.workloadHours" path="workloadHours" sortable="true" width="10%"/>
	<acme:list-column code="manager.task.list.label.workloadMinutes" path="workloadMinutes" sortable="true" width="10%"/>
</acme:list>
